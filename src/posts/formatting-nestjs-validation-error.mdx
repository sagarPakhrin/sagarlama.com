...
description: Nestjs validation errors messages are thrown in a single array which isn't much helpful for the client applications. In this blog post, we will look into structuring the error messages so it's helpful for the client application 
date: 06-23-2024
published: true
---
### Introduction
