...
Now let's commit the files and push it to github. Next time wherever you want to replicate the config. Just clone the repository and run `stow <package_name>` and the appropriate symlinks will be created automatically
