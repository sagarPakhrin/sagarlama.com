---
title: How to connect multiple databases with Nodejs and Prisma
description: Here's how you can connect multiple databases with prisma in nestjs using multiple schema by generating multiple prisma clients 
date: 03-13-2022
published: true
cover_image: https://res.cloudinary.com/dmvjadwhx/image/upload/v1688317601/prisma_yj0vs9.webp
metakeywords: prisma,nestjs,nodejs,database,multiple-database 
